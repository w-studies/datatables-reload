...
!(function (n) {
            ...
            var f,
              ...
              p =
                ...
                r.aLengthMenu &&
                  !r.iDisplayLength &&
                  (r.iDisplayLength = (
                    Array.isArray(r.aLengthMenu[0]) ? r.aLengthMenu[0] : r.aLengthMenu
                  )[0]),
                (r = be(P.extend(!0, {}, e), r)),
                F(h.oFeatures, r, [
                  'bPaginate',
    ...
    (w.util = {
      ...
      set: function (a) {
        ...
        return P.isPlainObject(a)
          ...
          : ((d = function (t, e, n) {
              for (
                var a, r, o, i, l = dt(n), n = l[l.length - 1], s = 0, u = l.length - 1;
                s < u;
                s++
              ) {
  ...
  function Lt(n) {
    ...
    var t = n.oClasses,
      ...
      l = P('<div/>', { id: i.f ? null : a + '_filter', class: t.sFilter }).append(
        P('<label/>').append(s)
      ),
  ...
  function Ht(t, e, n, a, r, o) {
    ...
    if ((0 !== w.ext.search.length && (n = !0), (l = Wt(t)), e.length <= 0)) t.aiDisplay = o.slice()
      ...
      for (
        (l || n || a || r.length > e.length || 0 !== e.indexOf(r) || t.bSorted) &&
          (t.aiDisplay = o.slice()),
          i = t.aiDisplay,
          s = 0;
        s < i.length;
    ...
    for (var e, n, a, r, o, i = t.aoColumns, l = !1, s = 0, u = t.aoData.length; s < u; s++)
      if (!(o = t.aoData[s])._aFilterData) {
        for (a = [], e = 0, n = i.length; e < n; e++)
          i[e].bSearchable
            ? 'string' != typeof (r = null === (r = S(t, s, e, 'filter')) ? '' : r) &&
              r.toString &&
              (r = r.toString())
            : (r = ''),
            r.indexOf &&
  ...
  function oe(t, e) {
    for (var n, a = -1, r = -1, o = 0, i = t.aoData.length; o < i; o++)
      (n = (n = (n = S(t, o, e, 'display') + '').replace(te, '')).replace(/&nbsp;/g, ' ')).length >
        a && ((a = n.length), (r = o))
    return r
  }
  function M(t) {
  ...
  function ie(t) {
    ...
    if ('ssp' != E(t) && 0 !== c.length) {
      ...
      o === c.length
        ? i.sort(function (t, e) {
            for (
              var n, a, r, o, i = c.length, l = d[t]._aSortData, s = d[e]._aSortData, u = 0;
              u < i;
              u++
            )
        ...
        : i.sort(function (t, e) {
            for (
              var n, a, r, o = c.length, i = d[t]._aSortData, l = d[e]._aSortData, s = 0;
              s < o;
              s++
            )
              if (
  ...
  function ce(t) {
    ...
    if (l.bSort && l.bSortClasses) {
      for (e = 0, n = r.length; e < n; e++)
        (a = r[e].src), P(N(t.aoData, 'anCells', a)).removeClass(o + (e < 2 ? e + 1 : 3))
      for (e = 0, n = i.length; e < n; e++)
        (a = i[e].src), P(N(t.aoData, 'anCells', a)).addClass(o + (e < 2 ? e + 1 : 3))
    }
    t.aLastSort = i
  }
  function fe(t, e) {
    for (
      ...
      (a = t.aoData[s])._aSortData || (a._aSortData = []),
        (a._aSortData[e] && !i) ||
          ((r = i ? n[s] : S(t, s, e, 'sort')), (a._aSortData[e] = l ? l(r) : r))
  }
  function de(n) {
    var t
    n._bLoadingState ||
        ...
        if (0 < l && t.time < +new Date() - 1e3 * l) n._bLoadingState = !1
          ...
          if (
            ...
            for (a = 0, r = t.columns.length; a < r; a++) {
              var s = t.columns[a]
              s.visible !== H &&
                (i ? i.column(a).visible(s.visible, !1) : (o[a].bVisible = s.visible)),
  ...
  function W(t, e, n, a) {
    if (
      ...
      a &&
        (n += '. For more information about this error, please see http://datatables.net/tn/' + a),
      e)
    )
  ...
  function _e(t, e, n, a, r) {
    for (
      ...
      for (
        l = 0,
          s = (i = e[f] && e[f].split && !e[f].match(/[\[\(:]/) ? e[f].split(',') : [e[f]]).length;
        l < s;
        l++
      )
  ...
  var Ie = [],
      ...
      P.extend(B.prototype, {
        ...
        iterator: function (t, e, n, a) {
          var r,
            ...
            p = this.selector
          for (
            'string' == typeof t && ((a = n), (n = e), (e = t), (t = !1)), o = 0, i = h.length;
            o < i;
            o++
          ) {
            var g = new B(h[o])
            if ('table' === e) (r = n.call(g, h[o], o)) !== H && d.push(r)
              ...
              for (
                c = this[o], 'column-rows' === e && (u = Fe(h[o], p.opts)), l = 0, s = c.length;
                l < s;
                l++
              )
                (f = c[l]),
        ...
        return (
          this.iterator('row', function (t, e, n) {
            ...
            for (u.splice(e, 1), a = 0, r = u.length; a < r; a++)
              if (
                ((s = (l = u[a]).anCells), null !== l.nTr && (l.nTr._DT_RowIndex = a), null !== s)
              )
    ...
    Ne =
        ...
        var e = this,
          t = this.iterator('column', function (t, e) {
            ...
            if (e === H) i.bVisible
              ...
              if (e)
                for (
                  var s = P.inArray(!0, N(o, 'bVisible'), r + 1), u = 0, c = l.length;
                  u < c;
                  u++
                )
                      ...
                      if (null === t || t === H || n) {
                        for (o = [], i = 0, l = d.length; i < l; i++)
                          for (r = d[i], s = 0; s < p; s++)
                            (u = { row: r, column: s }),
                              (!n ||
                                ((c = f[r]), t(u, S(a, r, s), c.anCells ? c.anCells[s] : null))) &&
                                o.push(u)
                        return o
                      }
      ...
      (w.versionCheck = w.fnVersionCheck =
        function (t) {
          for (
            var e, n, a = w.version.split('.'), r = t.split('.'), o = 0, i = r.length;
            o < i;
            o++
          )
      ...
      e('i18n()', function (t, e, n) {
        ...
        return (
          t === H && (t = e),
          'string' == typeof (t = n !== H && P.isPlainObject(t) ? (t[n] !== H ? t[n] : t._) : t)
            ? t.replace('%d', n)
            : t
        )
      }),
          ...
          P(r.nTable).on('order.dt.DT', function (t, e, n, a) {
            r === e &&
              ...
              o
                ...
                .addClass(
                  'asc' == a[e] ? l.sSortAsc : 'desc' == a[e] ? l.sSortDesc : i.sSortingClass
                ))
          })
        },
